...
void RemoteControl::sendMowMenu(boolean update) {
  ...
  sendSlider("o03", F("calibrate mow motor 2 - "), robot->motor2MowSenseCurrent, "", 1, 3000, 0);
  ...
  serialPort->print(F("motor1MowSenseScale: "));
  serialPort->println(robot->motor1MowSenseScale);
  serialPort->print(F("motor2MowSenseScale: "));
  serialPort->print(robot->motor2MowSenseScale);
  serialPort->println("}");
}
...
void RemoteControl::processMowMenu(String pfodCmd) {
  if (pfodCmd.startsWith("o02")) processSlider(pfodCmd, robot->motorMowPowerMax, 0.1);
    ...
    robot->motor1MowSenseScale = robot->motor1MowSenseCurrent / max(0, (float)robot->motor1MowSenseADC);
    processSlider(pfodCmd, robot->motor2MowSenseCurrent, 1);
    robot->motor2MowSenseScale = robot->motor2MowSenseCurrent / max(0, (float)robot->motor2MowSenseADC);
  }
