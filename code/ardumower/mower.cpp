...
Mower::Mower() {
  ...
  name = "LawnMower"; //Set the Name of BT
#else
  name = "Mini";
#endif
  ...
  motor1MowSenseScale        = ADC2voltage(1) * 1905;  // ADC to mower motor 1 sense milliamp
  motor2MowSenseScale        = ADC2voltage(1) * 1905;  // ADC to mower motor 2 sense milliamp
  ...
  startChargingIfBelow       = 29.3;      // start charging if battery Voltage is below (99999=disabled)
  ...
  chargingTimeout            = 21600000;  // safety timer for charging (ms) 21600000 = 6h  (2147483647=disabled)
  ...
  batSwitchOffIfIdle         = 15;          // switch off battery if idle (minutes, 0=off)
  ...
  batChargingCurrentMax       = 3.0;       // maximum current your charger can devliver
  ...
  wheelDiameter              = 218;        // wheel diameter (mm)
