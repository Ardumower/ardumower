...
int motorLeftRpmCounter = 0; // left wheel rpm counter
double motorLeftRpm = 0; // left wheel rpm
unsigned long lastMotorLeftRpmTime = 0; 
int motorRightRpmCounter = 0; // right wheel rpm counter
double motorRightRpm = 0; // right wheel rpm
unsigned long lastMotorRightRpmTime = 0; 
